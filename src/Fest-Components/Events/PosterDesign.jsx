...
<div className="hero min-h-screen"
    style={{
    backgroundImage: "url(https://www.nam.ac.uk/sites/default/files/styles/slice_sm/public/2019-05/poster-design-comp_slice_v2.jpg.webp?itok=1L0PisJ3)",
    }}>
<div className="hero-overlay bg-opacity-60 backdrop-blur-md"></div>
    <div className="hero-content text-white text-center">
        <div className="max-w-4xl">
            ...
            <button
                onClick={() => window.open('https://docs.google.com/forms/d/1kfEoEl834uziLWx-5D9-xexJ7W0qW1Whx7cMje7OyM4/edit?usp=drivesdk', '_blank')}   
  ...
  <section className="py-16 bg-[#020817]">
    <div className="container mx-auto px-4">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        Unleash your creativity and technical expertise at the Tejgaon College CSE Fest 2024 - Poster Design Competition! Open to undergraduate students, this event challenges participants to create an impactful poster within a 5-hour timeframe. Choose from one of four exciting themes: Programming Fundamentals, Artificial Intelligence, Cyber Security, or Networking, and bring your ideas to life!

        Participants will design their posters on-site, showcasing their visual and conceptual skills while exploring cutting-edge topics in technology. Gain valuable feedback from experienced academicians, engage with fellow innovators, and compete for thrilling prizes. Join us on December 10, 2024, at Tejgaon College and make your mark at the CSE Fest’s premier poster design competition!
        </p>
      </div>
    </div>
  </section>
  ...
  <div className="container mx-auto text-center">
    ...
    <button
      onClick={() => window.location.href = 'https://docs.google.com/forms/d/1kfEoEl834uziLWx-5D9-xexJ7W0qW1Whx7cMje7OyM4/edit?usp=drivesdk'}
